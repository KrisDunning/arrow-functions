...
//  the student object that the method "scope" is apart of. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//  the global object or the window in this instance.
// 3. Explain why "this" is different when an arrow function is used.
//  the arrow function has no scope on its own. So it will take the parent scope. If a normal function() is not used(e.x. joe.scope)
//  to set the scope level then It will go all the way to the top, the global or in this instance the window object(e.x joe.scopeArrow). 
